    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
		  ...
		  if (isset($_GET['c'])) {
			$c = protect($_GET['c']); ?>
			  <?php if($c == "send" OR $c == "request") { echo 'Send / Request Money'; } ?>
              <?php if($c == "deposit") { echo 'Deposit Fund'; } ?>
              <?php if($c == "withdrawal") { echo 'Withdraw Fund'; } ?>
              <?php if($c == "membership") { echo 'Membership'; } ?>
              <?php if($c == "chart") { echo 'Earning Chart'; } ?>
              <?php if($c == "reward") { echo 'Claim Rewards'; } ?>
		  <?php } ?>
