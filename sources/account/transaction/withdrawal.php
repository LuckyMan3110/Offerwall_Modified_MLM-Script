                                        ...
                                        <div class="user-connected-form-block">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <p>Payment Status: <?php echo DecodeTXStatus($row['status']); ?> <span class="float-right"><span style="font-size:22px;"><?php echo $row['amount']; ?> <?php echo $row['currency']; ?></span></span></p>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            if($GetValues->num_rows>0) {
                                                                while($gv = $GetValues->fetch_assoc()) {
                                                                    echo "<p>".GetFieldName($gv['field_id']).": <b>".$gv['value']."</b></p>";
                                                                }
                                                            } else { 
                                                                echo 'No data.';
                                                            }
