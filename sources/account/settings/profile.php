...
<form class="user-connected-from user-signup-form" action="" method="POST">
    <div class="row form-group">
        <div class="col">
            ...
            <input type="text" class="form-control" name="first_name" value="<?php echo idinfo($_SESSION['uid'],"first_name"); ?>">
        </div>
        <div class="col">
            <label><?php echo $lang['field_12']; ?></label>
            <input type="text" class="form-control" name="last_name" value="<?php echo idinfo($_SESSION['uid'],"last_name"); ?>">
        </div>
    </div>
    ...
    <div class="row form-group">
        <div class="col">
            ...
            <input type="text" class="form-control" name="city" value="<?php echo idinfo($_SESSION['uid'],"city"); ?>">
        </div>
        <div class="col">
            <label><?php echo $lang['field_15']; ?></label>
            <input type="text" class="form-control" name="zip_code" value="<?php echo idinfo($_SESSION['uid'],"zip_code"); ?>">
        </div>
    </div>
    <div class="form-group">
        <label><?php echo $lang['field_16']; ?></label>
        <input type="text" class="form-control" name="address" value="<?php echo idinfo($_SESSION['uid'],"address"); ?>">
    </div>
