...
<form class="user-connected-from user-signup-form" action="" method="POST">
    ...
    <button type="submit" name="2fa" value="disable" class="btn btn-danger float-right"><?php echo $lang['btn_14']; ?></button>
</form>
<br>
...
<div class="form-group">
        <div class="custom-control custom-checkbox">
            <div class="custom-checkbox-wrap">
                <input type="checkbox" class="custom-control-input" id="2fa_auth_login" name="2fa_auth_login" <?php if(idinfo($_SESSION['uid'],"2fa_auth_login") == "1") { echo 'checked'; } ?> value="yes">
    ...
    <div class="form-group">
        <div class="custom-control custom-checkbox">
            <div class="custom-checkbox-wrap">
                <input type="checkbox" class="custom-control-input" id="2fa_auth_send" name="2fa_auth_send" <?php if(idinfo($_SESSION['uid'],"2fa_auth_send") == "1") { echo 'checked'; } ?> value="yes">
    ...
    <div class="form-group">
        <div class="custom-control custom-checkbox">
            <div class="custom-checkbox-wrap">
                <input type="checkbox" class="custom-control-input" id="2fa_auth_withdrawal" name="2fa_auth_withdrawal" <?php if(idinfo($_SESSION['uid'],"2fa_auth_withdrawal") == "1") { echo 'checked'; } ?> value="yes">
...
<?php } else { ?>
    ...
    <button type="submit" name="2fa" value="enable" class="btn btn-success float-right"><?php echo $lang['btn_15']; ?></button>
    </form>
<?php } ?>