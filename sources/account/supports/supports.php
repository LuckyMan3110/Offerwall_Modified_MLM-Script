                ...
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <tbody>
                      <?php
                            ...
                            $statement = "support WHERE sender='$_SESSION[uid]' or recipient='$_SESSION[uid]'";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php if(idinfo($row['sender'],"account_type") == "1") { echo idinfo($row['sender'],"first_name")." ".idinfo($row['sender'],"last_name"); } else { echo idinfo($row['sender'],"business_name"); } if($_SESSION['uid'] == $row['sender']) { echo ' (You)'; } ?></td>
                                <td align="center">
                                    <?php
                                    $status = $row['status'];
                                    if($row['status'] == "1") {
