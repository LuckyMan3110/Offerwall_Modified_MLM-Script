...
$CheckTx = $db->query("SELECT * FROM transactions WHERE txid='$id' and sender='$_SESSION[uid]'");
													...
													<div class="col-md-12">
														<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
															...
															<?php
                                                                ...
                                                                if($FormBTN == "open") {
                                                                    ...
                                                                    if(empty($comment)) {
                                                                        ...
                                                                        $insert = $db->query("INSERT support (hash,sender,created_by,created,updated,status) VALUES ('$hash','$_SESSION[uid]','$_SESSION[uid]','$time','0','1')");
                                                                        $GetDispute = $db->query("SELECT * FROM support WHERE created_by='$_SESSION[uid]' ORDER BY id DESC LIMIT 1");
                                                                        $dispute = $GetDispute->fetch_assoc();
                                                                        $insert = $db->query("INSERT support_messages (uid,dispute_id,comment,attachment,time,is_admin,status) VALUES ('$_SESSION[uid]','$dispute[id]','$comment','','$time','0','1')");
															...
															<form class="user-connected-from user-login-form" action="" method="POST">
    															...
    															<button type="submit" name="open" value="open" class="btn btn-primary" style="float:right;"> Submit Ticket</button>
															</form>
														</div>
