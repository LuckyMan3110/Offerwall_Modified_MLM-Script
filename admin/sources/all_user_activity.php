	    ...
	    <div class="card-body">
            ...
            <form class="user-connected-from user-signup-form" action="" method="POST">
                <div class="row form-group">
                    ...
                    <div class="col">
                        <button type="submit" class="btn btn-primary btn-block" name="search" value="search" style="padding:11px;"><i class="fa fa-search"></i></button>
                    </div>
                </div>
            </form>
            <?php
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        if($Searching == "1") {
                            $statement = "activity WHERE uid='$row[id]' $Search";
                        ...
                        if($query->num_rows>0) {
                            while($row = $query->fetch_assoc()) {
                                ...
                                ?>
                                <tr>
                                    <td><?php echo ActivityDate($row['created']); ?></td>
