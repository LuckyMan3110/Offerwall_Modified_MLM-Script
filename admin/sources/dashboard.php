        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php $query = $db->query("SELECT * FROM users"); echo $query->num_rows; ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php $query = $db->query("SELECT * FROM users WHERE membership > 0"); echo $query->num_rows; ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
					<?php 
                        foreach($db->query("SELECT SUM(amount) FROM deposits WHERE currency= '$settings[default_currency]' and status='1' ") as $row) 
                        $td = number_format($row['SUM(amount)'], 2, '.', '');  
                    ?>
                <h3><?= $td ?></h3>

                <p>Total Deposits (<?= $settings['default_currency'] ?>)</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
					<?php 
                        foreach($db->query("SELECT SUM(amount) FROM withdrawals WHERE currency= '$settings[default_currency]' and status='3' ") as $row) 
                        $tw = number_format($row['SUM(amount)'], 2, '.', '');  
                    ?>
                <h3><?= $tw ?></h3>

                <p>Total Withdrawals (<?= $settings['default_currency'] ?>)</p>
              </div>
              <div class="icon">
