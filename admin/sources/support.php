					...
					<div class="card">
                        ...
                        <?php
                                            ...
                                            if($FormBTN == "message") {
                                                ...
                                                if(empty($message)) {
													...
													elseif(!empty($_FILES['uploadFile']['name']) && !in_array($fileextension,$extensions)) { echo error("Allowed file types: jpg,png and pdf."); }
														...
														EmailSys_SupportReply(idinfo($row['sender'],"email"),$row['hash'],"Your Support Ticket Has been Replied.","../");
                                            ...
                                            if($FormBTN == "close") {
                                                ...
                                                $row['status'] = '4';
                                                EmailSys_SupportClosed(idinfo($row['sender'],"email"),$row['hash'],"Your Support Ticket Has been Closed.","../");
                                            ...
                                            <div id="submit_message">
                                                <form action="" method="POST">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="submit" value="message">Submit message</button>
                                                </form>
                                            </div>
                                            <hr/>
                                            <form action="" method="POST">
                                                <button type="submit" class="btn btn-primary" name="submit" value="close">Close</button>
                                            </form>
                                            <?php } ?>
