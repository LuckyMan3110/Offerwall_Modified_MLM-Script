...
<html lang="en" >
    ...
    <body class="hold-transition login-page">
          ...
          <div class="card card-outline card-primary">
            ...
            <div class="card-body">
              ...
              <form action="" method="post">
                ...
                <div class="row">
                  <div class="col">
                    <button type="submit" name="login" value="Authorized" class="btn btn-primary btn-block" style="width:100%;">Sign In</button>
                  </div>
                  <!-- /.col -->
                </div>
              </form>
        ...
        <script src="<?=$settings['url']?>assets/new/dist/js/adminlte.min.js"></script>
        <script>
