<?php
define('STRIPE_API_KEY', gatewayinfo($_SESSION['stripe_gateway'],"a_field_2")); 
define('STRIPE_PUBLISHABLE_KEY', gatewayinfo($_SESSION['stripe_gateway'],"a_field_1")); 
...
if(!empty($_POST['stripeToken'])){
    ...
    $productName = $_SESSION['stripe_productName']; 
    $productNumber = $_SESSION['stripe_productNumber']; 
    $productPrice = $_SESSION['stripe_productPrice']; 
    $currency = $_SESSION['stripe_currency']; 
